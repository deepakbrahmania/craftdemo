...
import { getTotalBudget } from "./budgetAPI";
...
const budgetSlice = createSlice({
  ...
  reducers: {
    ...
    deleteBudget: (state, action) => initialState,
...
export const { addBudget, updateBudget, deleteBudget, addCategory, updateCategory, deleteTag } = budgetSlice.actions;
